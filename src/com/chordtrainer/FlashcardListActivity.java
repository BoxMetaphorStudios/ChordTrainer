...
public class FlashcardListActivity extends FragmentActivity implements
		FlashcardListFragment.Callbacks, FlashcardPagerFragment.PagerCallbacks {
	...
	@Override
	public void onPause() {
		((ChordApp) getApplication()).getChordPlay().shutUp();
	...
	public void onItemSelected(int pos) {
		if (mTwoPane)
			...
			Intent i = new Intent(this, FlashcardPagerActivity.class);
