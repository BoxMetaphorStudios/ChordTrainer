...
public class Prefs {
	...
	// option keys:
	private static final String OPTIONS_NAME = "ChordTrainerOptions";
	...
	//
	private static final String JAZZPOP_MODE_KEY = "JazzPopMode";
	...
	// 3 - Jazz/Pop
	// 4 - All Chords
	private static int QUIZ_LEVEL_DEFAULT = 0;
	// Quiz length:
	...
	// Jazz/Pop Mode:
	private static boolean JAZZPOP_MODE_DEFAULT = false;

	Prefs(Context context) {
		m_Prefs = context.getSharedPreferences(OPTIONS_NAME,
	...
	public void setJazzPopMode(boolean set) {
		setOptionBool(JAZZPOP_MODE_KEY, set);
	}

	public boolean getJazzPopMode() {
		return getOptionBool(JAZZPOP_MODE_KEY, JAZZPOP_MODE_DEFAULT);
	}
