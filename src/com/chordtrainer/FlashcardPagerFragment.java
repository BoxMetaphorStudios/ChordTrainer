...
import com.chordtrainer.FlashcardListFragment.Callbacks;
...
public class FlashcardPagerFragment extends Fragment {
	...
	private class FlashcardPagerAdapter extends FragmentStatePagerAdapter {
		...
		@Override
		public int getCount() {
			return m_App.getChordPlay().getChordInfoArray(
					new Prefs(getActivity()).getJazzPopMode()).length;
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		m_ViewPager.setAdapter(new FlashcardPagerAdapter(getActivity()
