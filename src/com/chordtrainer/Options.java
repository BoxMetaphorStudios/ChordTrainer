...
public class Options extends ListActivity {
	...
	String prefs[] = { "Quiz Settings", "Info/Credits" };
...
//			break;
	...
	private void quizSettingDialog() {
		...
		final RadioButton[] radioBut = new RadioButton[5];
		...
		radioBut[3] = (RadioButton) layout.findViewById(R.id.butQuizLevel4);
		radioBut[4] = (RadioButton) layout.findViewById(R.id.butQuizLevel5);

		final CheckBox checkJazzPopMode = (CheckBox) layout
				.findViewById(R.id.checkJazzPopMode);
		...
		checkJazzPopMode
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
							boolean isChecked) {
						if (isChecked == false) {
							if (radioBut[3].isChecked() == true) {
								radioBut[3].setChecked(false);
								radioBut[2].setChecked(true);
							}
							radioBut[3].setVisibility(View.GONE);
						} else
							radioBut[3].setVisibility(View.VISIBLE);
					}
				});
		...
		butOk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// set Jazz/Pop mode
				m_Prefs.setJazzPopMode(checkJazzPopMode.isChecked());
				// set no. questions:
		...
		checkJazzPopMode.setChecked(jazz);
